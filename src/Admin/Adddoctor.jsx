...
// ///////////////////////////////////////////////////////////////////////////////
  ...
  {hospitalname.map((hospital) => (
    <option key={hospital.id} value={hospital.name}>
      ...
      {/* Vedio Doctor */}
      <div className="my-2">
        <h3  className="d-inline-block">Is Doctor available for VedioCall :</h3>
        <label className="mx-2">
          <input name="vedio" type="radio" value="true" onChange={handleVedioChange} />
          Yes
        </label>
        <label>
          <input name="vedio" type="radio" value="false" onChange={handleVedioChange} />
          No
        </label>
      </div>
...
/>
      ...
      <div>
        ...
        {dayOfWeek.map(dayOfWeek => {
          const selectedDay = formData.schedules.find(d => d.dayOfWeek === dayOfWeek);
      ...
      <div className="form-group">
                    <button type="submit" className="btn btn-primary me-3">Add Doctor</button>
