     ...
     <div className='container-fluid'>
            ...
            <form onSubmit={updatefaq} className="my-5">
                <div className="form-group">
                    ...
                    <input type="text" id="question" className="form-control mt-2 mb-4" value={updatedfaq.question ||""} onChange={(e) =>setupdatedfaq(prev => ({...prev,question: e.target.value}))} />
                </div>
                <div className="form-group">
                    <label htmlFor="answer">Answer</label>
                    <input type="text" id="answer" className="form-control mt-2 mb-4" value={updatedfaq.answer ||""} onChange={(e) =>setupdatedfaq(prev => ({...prev,answer: e.target.value}))} />
                </div>
                <div className="form-group">
                    <button type="submit" className="btn btn-primary me-3">Update FAQ</button>
