  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `https://tumorhospital.runasp.net/api/Profile/Receptionist`,
        {
          method: "PUT",
          headers: {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          errData.message || "Failed to update receptionist profile",
        );
      }
      setSuccess(true);
        ...
        <div className="profile-form-header">
          ...
          <div>
            ...
            <p className="profile-form-subtitle">
              Modify your contact and location details.
            </p>
          </div>
        </div>
        ...
        <form className="profile-form" onSubmit={handleSubmit}>
          ...
          <div className="profile-form-actions">
            <button
              ...
              onClick={() => navigate("/Reciptionprofile")}
            >
              Cancel
            </button>
            <button
